const msgCadastro = {
   ...
   "senha.required": "É necessario preencher a senha.",
   "email_usuario.required": "É necessario preencher o email do usuário.",
   "email_usuario.unique": "Email já possui cadastro.",
